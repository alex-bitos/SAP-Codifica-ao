...
O Excel contém apenas a categoria Tubo como Matéria Prima. O importador aplica as regras oficiais da V3.11 e adiciona Tubo como Produto Intermediário (`PITU`) com os mesmos campos técnicos da categoria `MPTU`; portanto, o banco final terá 146 categorias após a importação inicial.
